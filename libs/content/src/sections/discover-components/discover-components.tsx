...
import { zGrid, halfZGrid } from '@watheia/content.layout.grid-presets.z-grid';
...
export function DiscoverComponents(props: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      ...
      data-bit-id="watheia.content/sections/discover-components"
    >
      <div className={classNames(textColumn, marginCenter)}>
        ...
        >
          Forget about maintaining additional docs, websites, wikis, and tools.
          Watheia makes sure every single component is documented, organized and
          discoverable at any scale.
        </Paragraph>
      </div>

      <Grid
        colMd={12}
        className={classNames(text.left, zGrid, alignItems.center)}
      >
        <div>
          ...
          <Paragraph>
            Looking for a React button component with up to 30kb bundle-size,
            styled with styled-components, and tested with Jest? Easy, just hit
            "search".
          </Paragraph>
        </div>
        ...
        <div>
          ...
          <Paragraph>
            With Watheia, you can focus on writing code and watch how every
            component’s documentation is generated, updated and maintained
            automatically. Have a coffee.
          </Paragraph>
        </div>
        <Image
          src="homepage-bit/button-docs.png"
          alt="generated docs"
          fullWidth
        />
      </Grid>
      ...
      >
        <div>
          ...
          <Paragraph>
            The best way to experience a component is to try it hands-on.
            Watheia’s hot-reloading playground lets you quickly learn how
            components work and save examples.
          </Paragraph>
        </div>
